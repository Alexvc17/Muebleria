...
<div class="container">
  <div class="row">
    ...
    <div class="col-8">
    <h2><em> <strong>Realizar Abono</strong> </em></h2>
    <br>
<form action="{{route('consulta_abono')}}" method="POST">
@csrf
  <div class="input-group">
  <input type="search" class="form-control rounded" placeholder="ingrese cedula" id="cedulaCli" name="cedulaCli" aria-label="Search"
    aria-describedby="search-addon" required>
<br>
    &nbsp&nbsp&nbsp<input type="number" class="form-control rounded" placeholder="monto" id="monto" name="monto" aria-label="Search"
    aria-describedby="search-addon" required>
