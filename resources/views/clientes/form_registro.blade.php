...
<div class="container">
<h2><em> <strong>Registro de Cliente</strong> </em></h2>
<br>
...
@csrf
  ...
  <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
        ...
        <input type="text" class="form-control" placeholder="Nombre del Cliente" id="nombreCli" name="nombreCli" aria-label="Username" aria-describedby="basic-addon1" required>
        </div>
  ...
  <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-5 6s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zM11 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5zm.5 2.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4zm2 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2zm0 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2z"/>
        ...
        <input type="text" class="form-control" placeholder="Apellido del Cliente" id="apellidoCli" name="apellidoCli" aria-label="Username" aria-describedby="basic-addon1" required>
        </div>
  ...
  <path d="M3 8.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0 2a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5zm0-5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5v-1z"/>
        ...
        <input type="text" class="form-control" placeholder="Cedula" id="cedulaCli" name="cedulaCli" aria-label="Username" aria-describedby="basic-addon1" required>
        </div>
  ...
  <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/>
        ...
        <input type="text" class="form-control" placeholder="Direccion" id="direccionCli" name="direccionCli" aria-label="Username" aria-describedby="basic-addon1" required>
        </div>
  ...
  <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"/>
        ...
        <input type="text" class="form-control" placeholder="Telefono" id="telefonoCli" name="telefonoCli" aria-label="Username" aria-describedby="basic-addon1" required>
        </div>
  ...
  <path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414.05 3.555zM0 4.697v7.104l5.803-3.558L0 4.697zM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586l-1.239-.757zm3.436-.586L16 11.801V4.697l-5.803 3.546z"/>
        ...
        <input type="email" class="form-control" placeholder="Email" id="emailCli" name="emailCli" aria-label="Username" aria-describedby="basic-addon1" required>
        </div>
